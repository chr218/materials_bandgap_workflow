...
#Build framework
frmwrk = mx2(formula='MoS2', kind='2H', a=3.18, thickness=3.19, size=(5, 5, 2), vacuum=5.5)
ucv = frmwrk.get_cell()#Extract "unit cell vector"
ucv[2][-1] += 4#Expand unit cell vector in z-direction.
...
gen_orient(gas_mol,frmwrk,10,True,False,True)
